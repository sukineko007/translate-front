...
export default {
  ...
  {
    "alt": "[能量少女耶]",
    "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/4d/chuangzaoying_shoushi_org.png"
  },
  {
    "alt": "[为爱发光]",
    "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/20/chuangzaoying_yingyuan_org.png"
  },
  {
    "alt": "[创造营2020]",
    "src": "http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/77/chuangzaoying_biaoshi_org.png"
  },
  {
    "alt": "[心]",
...
yuncodeEmotions:[
  ...
  mounted() {
    var editor = new E("#toolbar", "#content"); //创建富文本实例
    ...
    editor.customConfig.emotions = [
      {
        title: "新浪表情",
        type: "image",
        content: this.sinaEmotions
      },
      {
        title: "云Code",
        type: "image",
        content: this.yuncodeEmotions
      }
    ];
